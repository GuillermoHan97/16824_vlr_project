...
argparser.add_argument('--test_file', type=str, default='data/split/val1.list', help='Test list')
...
argparser.add_argument('--weights', type=list, default=[0.075, 0.925], help='Class weight')
