...
original_path = '/data/ego/json_original'           # the saving path of annotation of the face bbox
result_LAM_path = '/data/ego/result_LAM'            # the saving path of LAM annotation
result_TTM_path = '/data/ego/result_TTM'            # the saving path of TTM annotation
