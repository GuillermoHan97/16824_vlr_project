...
DATA_DIR = "/data/vlr/data/ego4d_data_AV/si_data"
...
for video in ori_annot_val['videos']:
    ...
    for clip in video['clips']:
        ...
        cmd = f'ffmpeg -y -i {DATA_DIR}/../v1/full_scale/{video_uid}.mp4 -ss {start_sec} -to {end_sec} -c:a copy -vcodec libx264 -keyint_min 2 -g 1  -y {DATA_DIR}/ego/videos/{clip_uid}.mp4'
